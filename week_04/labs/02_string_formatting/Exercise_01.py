...
# What we have is not dictionary, but List of dictionaries. So loop through
for list_item in office:
    for key, value in list_item.items():
        if key == "full_name":
            #Below I am creating list of the full name, so I can switch last vs first name
            name_list = value.split(" ")
            #Then I combine to string LAST NAME, First name
            combine_name = name_list[1].upper() + ", " + name_list[0]

    #print the full f stirng with padding set to 30, for the full name
    print(f"{combine_name:30}{value}")
