...
# source: https://www.reddit.com/r/beginnerprojects/comments/19kxre/project_99_bottles_of_beer_on_the_wall_lyrics/
...
# RULES
# 1) If you are going to use a list for all of the numbers, do not manually type them all in.
...
## a fun list comprehension that doesn't quite cut the slack. :)
